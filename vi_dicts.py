rpictparams = {"-ab": (2, 4, 8), "-ad": (256, 1024, 4096), "-as": (32, 256, 1024), "-aa": (0, 0, 0), "-ar": (8, 32, 128),   
                   "-ss": (0, 2, 5), "-st": (1, 0.75, 0.1),
                   "-lw": (0.0001, 0.00001, 0.0000002), "-lr": (4, 8, 16), 
                   "-pj": (0.6, 0.9, 1.0), "-pt":(0.15, 0.05, 0.0), "-ps": (16, 4, 1), 
                   "-dj": (0.0, 0.7, 1), "-ds": (0, 0.5, 0.15), "-dr": (0, 1, 3), "-dt": (0.5, 0.05, 0.0), "-dc": (0.25, 0.5, 1)}

rvuparams = {"-ab": (2, 3, 4), "-ad": (256, 1024, 4096), "-as": (32, 256, 1024), "-aa": (0, 0, 0), "-ar": (8, 32, 128), 
                   "-dj": (0, 0.7, 1), "-ds": (0, 0.5, 0.15), "-dr": (0, 1, 3), "-ss": (0, 2, 5), "-st": (1, 0.75, 0.1), "-lw": (0.0001, 0.00001, 0.0000002), 
                   "-lr": (3, 3, 4), "-ps": (16, 4, 1)}

rtraceparams = {"-ab": (2, 4, 8), "-ad": (1024, 2048, 4096), "-as": (32, 256, 1024), "-aa": (0, 0, 0), "-ar": (8, 32, 128),
              "-dj": (0, 0.7, 1), "-ds": (0, 0.5, 0.15), "-dr": (1, 3, 5), "-ss": (0, 2, 5), "-st": (1, 0.75, 0.1), 
              "-lw": (0.0001, 0.00001, 0.000002), "-lr": (2, 4, 8)}

rtracecbdmparams = {"-ab": (4, 8), "-ad": (1024, 4096), "-as": (512, 2048), "-aa": (0, 0), "-ar": (32, 128),
